package net.pemiridosa.binslot.event;

import net.pemiridosa.binslot.extension.BinSlot;
...
import net.pemiridosa.binslot.mixin.client.accessor.SlotAccessor;
import net.pemiridosa.binslot.network.payload.MouseClickC2SPayload;
